...
def build_model(units=50, dense_nodes=10, activation='relu', optimizer='adam', 
                ...
                num_dense_layers=1, look_back=1, input_shape=None):
...
for i in range(num_instantiations):
    ...
    random_params = {
        'units': np.random.randint(20, 100),
        ...
        'num_lstm_layers': np.random.randint(1, 3),
        'num_gru_layers': np.random.randint(0, 2),
